...
function generateModal(project) {
  ...
  <div class="modal-paragraph item2">
    <p>${project.modalDescription}</p>
  </div>
  <div class="flex-row modal-btn-set item3">
    <a href="${project.liveLink}" type="button" class=" modal-btn-livelink button-project-card flex-row">
    <span>See Live</span>
    ...
    <a href="${project.sourceCodeLink}" type="button" class="modal-btn-source button-project-card flex-row">
